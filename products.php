...
<div id="brands">
    ...
    <h2 class="wow slideInLeft" style="visibility: visible; animation-name: slideInLeft;"><?php echo $_GET[category] ?></h2>
		<br><Br>
...
<a href='pdesc.php?id=$row[id]'>
	<div class='col-md-3' style='padding-top:20px'>
		<div class='card card-product-grid'>
		 <img src='$row[img]'>
			<figcaption class='info-wrap'>
			<center>	<a href='pdesc.php?id=$row[id]' class='title'>$row[title]</a></center>
