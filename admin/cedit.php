...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="editcategory.php" class="w3-bar-item w3-button w3-padding  w3-blue"><i class="fa fa-users fa-fw"></i>  Edit/Delete Category</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i>Update Category</b></h5>
  </header>
...
$sql = "UPDATE category SET name='$_POST[name]', image='$img' WHERE id='$_GET[id]'";
...
<input class="w3-input" type="text" name="name" value="<?php echo $n ?>" required>
<br>
<label>image</label>
...
<br>
  ...
  <input type="submit" class="w3-btn w3-blue-grey" value="Update Category">
</form>
