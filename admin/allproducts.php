...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="allproducts.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-bullseye fa-fw"></i> All Product</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> All Products</b></h5>
  </header>
...
<div class='w3-third' style='padding-top:10px;padding-left:20px;'>
<div class='w3-card'>
<img src='$row[img]' style='height:100%;width:100%; max-width:200px;max-height:200px'>
<div class='w3-container'>
