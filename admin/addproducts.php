...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="addproducts.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-bullseye fa-fw"></i> Add Product</a>
...
$sql = "INSERT INTO products (title, category, img, keywords,description,price)
VALUES ('$_POST[title]', '$_POST[category]', '$base64','$_POST[keywords]','$_POST[description]','$_POST[price]')";

if ($conn->query($sql) === TRUE) {
    
  echo"<script>location.href='padded.php'</script>";
} else {
  echo"<script>location.href='padded_failed.php'</script>";
...
<select class="w3-input"  name="category" required>
...
<input class="w3-input" type="text" name="keywords">
<br>
